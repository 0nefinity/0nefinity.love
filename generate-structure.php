 ...
 *   - Can be manually triggered: /generate-structure.php?force=1
 */

define('SITEMAP_FILE', __DIR__ . '/sitemap.xml');
define('CACHE_FILE', __DIR__ . '/.sitemap-cache');
...
function needsRegeneration() {
    ...
    $currentMtime = filemtime(__DIR__);
